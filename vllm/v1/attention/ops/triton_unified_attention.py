...
def kernel_unified_attention(
    ...
    # When False, disable causal masking inside the tile loop. DDTree
    # (PR #42910) uses this to verify a tree of draft tokens with a
    # custom qq_bias instead of a strict causal triangle.
